          ...
          <div className="space-y-6">
              <div>
                  ...
                  <Container layout="grid">
                      {/* the jsx used inside a component is passed as children to the component in this case collection of container gets*/}
                      {/* passed as children to the container and this is how children props work */}
                      {/*andIf you don’t accept children, then anything you write between the component’s
                      opening and closing tags is LOST.*/}
                      <Card title="User Profile" color="blue">
                          {/*// similarly the jsx from name to role is children to card*/}
                          <p className="mb-2">
